...
export const canonicalFieldMappings: readonly CanonicalFieldMapping[] = [
  { key: "revenue", statementSource: "income_statement", acceptedAliases: ["Revenue", "Total revenue", "Net revenue", "Sales", "Net sales", "Turnover", "Operating revenue"], excludedAliases: ["Gross profit", "Segment revenue", "Order intake"], extraction: "direct" },
  ...
  { key: "ebit", statementSource: "income_statement", acceptedAliases: ["EBIT", "Earnings before interest and tax", "Operating profit", "Operating income"], excludedAliases: ["EBITDA", "Adjusted EBITDA", "EBITA", "Profit before tax"], extraction: "direct" },
  ...
  { key: "totalDebt", statementSource: "balance_sheet", acceptedAliases: ["Total debt", "Total borrowings", "Interest-bearing debt"], excludedAliases: ["Net debt", "Lease liabilities"], extraction: "direct-or-derived", derivationId: "total-debt-components" },
  ...
  { key: "operatingCashFlow", statementSource: "cash_flow", acceptedAliases: ["Net cash from operating activities", "Net cash from operations", "Cash generated from operations", "Operating cash flow"], excludedAliases: ["Free cash flow", "EBITDA", "Operating profit"], extraction: "direct" },
