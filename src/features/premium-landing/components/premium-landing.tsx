...
const capabilitySections = [
  ...
  { number: "02", id: "ratios", title: "Ratio Analysis", text: "Inspect every registered ratio, its history, formula, availability and directional meaning.", href: "/analysis/ratios", icon: Sparkles },
  { number: "03", id: "dupont", title: "DuPont Drivers", text: "See exactly how margin, turnover and leverage reconcile into return on equity.", href: "/analysis/dupont", icon: GitBranch },
  { number: "04", id: "scenarios", title: "Scenario Lab", text: "Test explicit statement assumptions through the same validated financial engine.", href: "/scenario", icon: SlidersHorizontal },
  { number: "05", id: "engine", title: "Engine Map", text: "Trace every output from canonical input through deterministic analytical stages.", href: "/engine-map", icon: Network },
];
...
export function PremiumLanding({ viewModel }: { viewModel: PremiumLandingViewModel }) {
  ...
  return (
    <main className="premium-shell min-h-screen overflow-hidden bg-background text-neutral-50">
      ...
      <section className="relative z-10 mx-auto grid max-w-[1340px] gap-12 px-5 pb-20 pt-20 sm:px-8 lg:grid-cols-12 lg:items-center lg:pb-28 lg:pt-28">
        <div className="premium-enter lg:col-span-6">
          ...
          <p className="mt-5 text-[clamp(1.2rem,2vw,1.65rem)] leading-snug text-neutral-400">Not just calculate what happened.</p>
          <p className="mt-7 max-w-xl text-body leading-7 text-neutral-300">Transform financial statements into validated ratios, a transparent Financial Health Score, deterministic insights, DuPont drivers and statement-based scenarios.</p>
        ...
        <div className="premium-enter relative lg:col-span-6" style={{ animationDelay: "120ms" }}>
          <div className="premium-panel relative overflow-hidden rounded-xl p-5 shadow-3 md:p-7">
